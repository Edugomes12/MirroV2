#!/usr/bin/env python3
"""
MirrorGlass V4.7.1 - Soft Edges Protection System (FINAL)
==========================================================

NOVIDADES EM V4.7.1:
✅ Threshold suspicious_ratio ajustado: 0.15 (era 0.12)
✅ Correção final para fotos de vans em galpão

NOVIDADES EM V4.7:
✅ Regra GLASS_SAFE - Protege fotos reais com bordas suaves
✅ Ruído alto (65+) + bordas fracas (< 32) = NATURAL, não IA!
✅ Regra de bordas artificiais mais inteligente (considera ruído)
✅ Threshold de reflexo dominante 35% (era 40%)

CORREÇÃO DE FALSOS POSITIVOS:
- Fotos de vans/veículos em galpão (ruído natural, bordas soft)
- Fotos levemente desfocadas ou com compressão
- Câmeras de celular com ruído de sensor alto

Sistema completo com:
- Detector de Perfeição Excessiva (V4.3)
- Detector de Superfícies Lisas (V4.2)
- Análise Regional (V4.5)
- ReflectionMask 3 Camadas (V4.6)
- Soft Edges Protection (V4.7.1 - FINAL!)

Uso:
    from mirrorglass_v4_7_soft_edges import MirrorGlass
    
    detector = MirrorGlass()
    resultado = detector.analisar("foto.jpg", mostrar_logs=True)

Autor: MirrorGlass AI Detection System
Versão: 4.7.1 - Soft Edges Protection (FINAL)
Data: 24/11/2025
"""
...
class SequentialAnalyzer:
    ...
    def analyze_sequential(self, image) -> Dict[str, Any]:
        ...
        if regional_analysis['is_localized']:
