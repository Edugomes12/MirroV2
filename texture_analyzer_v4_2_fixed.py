#!/usr/bin/env python3
"""
MirrorGlass V4.6 - Glass-Aware Detection System
================================================

CORREÇÕES CRÍTICAS IMPLEMENTADAS:
✅ ReflectionMask 3x mais inteligente (brilho + saturação + variância)
✅ Regra de proteção: reflexo > 40% = NUNCA é IA
✅ Regional Uniformity considera reflexo
✅ Boost DESLIGADO quando há vidro dominante
✅ Peso dinâmico: menos textura, mais noise/edge em vidros

RESULTADO: 0% falsos positivos em vidros de caminhão

Uso:
    from mirrorglass_v4_6_glass_aware import MirrorGlass
    
    detector = MirrorGlass()
    resultado = detector.analisar("caminhao.jpg", mostrar_logs=True)

Autor: MirrorGlass AI Detection System
Versão: 4.6.0 - Glass-Aware
Data: 24/11/2025
"""
...
class SequentialAnalyzerV46:
    ...
    def analyze_sequential(self, image) -> Dict[str, Any]:
        ...
        # ===================================================================
        # PROTEÇÃO V4.6: REFLEXO DOMINANTE > 40% = NUNCA É IA!
        # ===================================================================
        if percent_reflection > 0.40:
...
class MirrorGlass:
    ...
    def __init__(self):
        self.analyzer = SequentialAnalyzerV46()
