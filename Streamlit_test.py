...
from mirrorglass_v4_6_glass_aware import SequentialAnalyzer

st.set_page_config(
    page_title="MirrorGlass V4.2 - DEBUG MODE",
    page_icon="🔍",
    layout="wide",
...
# Título
st.title("🔍 MirrorGlass V4.2 - Detector de Fraudes [DEBUG MODE]")
    ...
    if relatorio_dados:
        ...
        with col_d3:
            ...
            st.download_button(
                ...
                data=json.dumps(json_full, indent=2, ensure_ascii=False),
